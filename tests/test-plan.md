...
2. Apa yang akan diuji
    Fitur Tracking & Analisis:
    - Input Pengeluaran: Memastikan saldo berkurang otomatis saat user memasukkan nominal pengeluaran.
    ...
    - Isolasi Saldo: Memastikan saldo yang sudah masuk ke Brankas tidak ikut terpotong saat melakukan transaksi di fitur  utama.
